...
Although the application is fully functional, several enhancements could further improve its capabilities.

Potential future work includes:

## Hybrid Retrieval

Combine keyword search and semantic search to improve retrieval quality.

---

## Reranking

Introduce a cross-encoder reranker to improve the ordering of retrieved documents before generation.

---

## Metadata Filtering

Allow users to filter books by:
...
Provide direct citations linking generated responses to the original book pages and discussion threads.

---

## Conversation Memory

Support multi-turn conversations by maintaining conversational context across multiple user interactions.

---

## Additional LLM Providers

Because the architecture abstracts LLM interactions behind a dedicated module, additional providers can be integrated with minimal changes.
...
Automate evaluation to run after significant changes to retrieval, prompting, or embeddings, enabling regression detection over time.
